...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOK_ADD = 4,                    /* TOK_ADD  */
  YYSYMBOL_TOK_SUB = 5,                    /* TOK_SUB  */
  YYSYMBOL_TOK_MUL = 6,                    /* TOK_MUL  */
  YYSYMBOL_TOK_DIV = 7,                    /* TOK_DIV  */
  YYSYMBOL_TOK_EQUAL = 8,                  /* TOK_EQUAL  */
  YYSYMBOL_TOK_QUESTION = 9,               /* TOK_QUESTION  */
  YYSYMBOL_TOK_REVERSE = 10,               /* TOK_REVERSE  */
  YYSYMBOL_TOK_CARET = 11,                 /* TOK_CARET  */
  YYSYMBOL_TOK_HALT = 12,                  /* TOK_HALT  */
  YYSYMBOL_TOK_ERROR = 13,                 /* TOK_ERROR  */
...
static const char *const yytname[] =
{
  ...
  "TOK_ADD", "TOK_SUB", "TOK_MUL", "TOK_DIV", "TOK_EQUAL", "TOK_QUESTION",
  "TOK_REVERSE", "TOK_CARET", "TOK_HALT", "TOK_ERROR", "$accept",
  "program", "commands", "command", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* program: commands  */
#line 39 "parser.y"
             { generate((yyvsp[0].node));
...
#line 1110 "parser.tab.c"
  ...
  case 5: /* command: TOK_NUMBER  */
#line 49 "parser.y"
                    { (yyval.node) = create_val_node((yyvsp[0].val)); }
#line 1116 "parser.tab.c"
    break;

  case 6: /* command: TOK_ADD  */
#line 50 "parser.y"
                   { (yyval.node) = create_op('+'); }
#line 1122 "parser.tab.c"
    break;

  case 7: /* command: TOK_SUB  */
#line 51 "parser.y"
                  { (yyval.node) = create_op('-'); }
#line 1128 "parser.tab.c"
    break;

  case 8: /* command: TOK_MUL  */
#line 52 "parser.y"
                   { (yyval.node) = create_op('*'); }
#line 1134 "parser.tab.c"
    break;

  case 9: /* command: TOK_DIV  */
#line 53 "parser.y"
                    { (yyval.node) = create_op('/'); }
#line 1140 "parser.tab.c"
    break;

  case 10: /* command: TOK_EQUAL  */
#line 54 "parser.y"
                    { (yyval.node) = create_op('='); }
#line 1146 "parser.tab.c"
    break;

  case 11: /* command: TOK_CARET  */
#line 55 "parser.y"
                    { (yyval.node) = create_op('^'); }
#line 1152 "parser.tab.c"
    break;

  case 12: /* command: TOK_QUESTION  */
#line 56 "parser.y"
                    { (yyval.node) = create_op('?'); }
#line 1158 "parser.tab.c"
    break;

  case 13: /* command: TOK_REVERSE  */
#line 57 "parser.y"
                    { (yyval.node) = create_op('r'); }
